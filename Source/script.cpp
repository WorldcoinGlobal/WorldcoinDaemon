...
bool IsCanonicalSignature(const valtype &vchSig) {
    // See https://worldcointalk.org/index.php?topic=8392.msg127623#msg127623
...
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet)
{
    ...
    if (mTemplates.empty())
    {
        ...
        // Worldcoin address tx, sender provides hash of pubkey, receiver provides signature and pubkey
